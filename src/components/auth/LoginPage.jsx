...
export default function LoginPage() {
  ...
  const { login, googleLogin, parseAuthError } = useAuth();
      ...
      >
        <div className="glass-card p-8 md:p-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-text-secondary mt-1">Sign in to FlowDo</p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-border text-primary focus:ring-primary/20 accent-[var(--color-primary)]"
                />
