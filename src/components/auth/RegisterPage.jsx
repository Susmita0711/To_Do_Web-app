...
import { Mail, Lock, Eye, EyeOff, User, Zap, Camera, X } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const { register, googleLogin, parseAuthError } = useAuth();
      ...
      >
        <div className="glass-card p-8 md:p-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-text-secondary mt-1">Start your productivity journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex justify-center">
              <div className="relative">
                <div
                  ...
                  className="w-20 h-20 rounded-full bg-surface-dim border-2 border-dashed border-border flex items-center justify-center cursor-pointer hover:border-primary/50 transition overflow-hidden"
                >
                  {photoPreview ? (
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-border text-primary focus:ring-primary/20 accent-[var(--color-primary)]"
              />
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="w-full py-3 rounded-xl border border-border bg-surface hover:bg-surface-dim font-medium text-sm text-text-primary flex items-center justify-center gap-3 transition disabled:opacity-50"
          >
            {googleLoading ? (
